...
extension PredicateBuilder {
    func buildPredicateTrackerId(id: UUID) -> NSPredicate {
        predicateTracker(id: id)
    }
    
    func buildPredicateCategoryId(id: UUID) -> NSPredicate {
        predicateCategory(id: id)
    }
...
private extension PredicateBuilder {
    ...
    func predicateTracker(id: UUID) -> NSPredicate {
        NSPredicate(
            format: "%K == %@",
            #keyPath(TrackerObject.id),
            id as CVarArg
        )
    }
    
    func predicateCategory(id: UUID) -> NSPredicate {
        NSPredicate(
            format: "%K == %@",
            #keyPath(CategoryObject.id),
            id as CVarArg
        )
    }
