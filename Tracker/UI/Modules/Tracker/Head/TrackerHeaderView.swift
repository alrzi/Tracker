...
final class TrackerHeaderView: UIView {
    ...
    private let onDatePickerValueChanged: (Date) -> Void
    private let onPlusButton: () -> Void
    
    // MARK: - Init
    init(
        onPlusButton: @escaping () -> Void,
        onDatePickerValueChanged: @escaping (Date) -> Void
    ) {
        self.onPlusButton = onPlusButton
        self.onDatePickerValueChanged = onDatePickerValueChanged
...
private extension TrackerHeaderView {
    ...
    private func datePickerValueChanged() {
        onDatePickerValueChanged(datePicker.date)
    }
