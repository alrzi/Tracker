...
final class CreateTrackerViewModelImpl: ObservableObject {
    ...
    private let router: CreateTrackerViewRouter
    private var dataSource: DataSourceProtocol
    private let trackerKind: TrackerKind
    ...
    init(
        ...
        router: CreateTrackerViewRouter
    ) {
        ...
        trackerKind == .occasional ? schedule = WeekDay.allDaysOfWeek : nil
